...
class RectangularRoom(object):
    ...
    def getRandomPosition(self):
        ...
        """
        randomX = random.choice(range(self.width))
        randomY = random.choice(range(self.height))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):        
        ...
        newposition = pos.getNewPosition(self.getRobotDirection(), self.speed)
...
#num_robots, speed, width, height, min_coverage, num_trials,
#                 robot_type):
...
#showPlot1('Robots','Num Robots', 'Times')

#
# 2) Write a function call to showPlot2 that generates an appropriately-labeled
#     plot.
#
showPlot2("yum","yuck","yall")
#
